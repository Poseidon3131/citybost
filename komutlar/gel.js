...
.setColor("#7289D")
.setDescription(`${kullanıcı}, ${message.author} Kullanıcısı Seni <#${message.member.voice.channel.id}> Odasına Çekmek İstiyor. Kabul ediyormusun ?`)
  
let mesaj = await message.channel.send(log)
await mesaj.react("<:tik:839802059213242399>")
await mesaj.react("<:x_:839771014937444392>")
